...
- Navigate to the Client page. Then click on the Add Button.
- For editing and deleting clients simply click on the edit/delete icon.
- You cannot edit a client linked to existing tasks. Doing so will produce an error message for the user.
...
You can WhatsApp your client directly from the client page. You can also send them a message 
if they are not in your existing contacts list.
